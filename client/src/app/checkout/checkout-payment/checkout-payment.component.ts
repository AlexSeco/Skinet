...
export class CheckoutPaymentComponent implements OnInit {
  ...
  ngOnInit(): void {
    loadStripe('pk_test_51OuAhxDyUDZG83Y0y4GHuyuJJCfWYSz2q9xP3cCIWJyedc16gjXYGAevRCYbnfKRoZ8YBtYZ3hTNRvS6OO6Rjs6r00SLGFaHJ1').then(stripe => {
      this.stripe = stripe;
  ...
  private getOrderToCreate(basket: Basket): OrderToCreate {
    ...
    const shipToAdress = this.checkoutForm?.get('addressForm')?.value as Address;

    if (!deliveryMethodId || !shipToAdress) throw new Error('Problem with basket  ');
